...
public static class ThemeTokenCatalog
{
    ...
    public static readonly IReadOnlyList<ThemeToken> All = new ThemeToken[]
    {
        ...
        // ─── اللَوحَة: التَقييم ─────────────────────────────────────────
        // ذَهَب النُجوم. رَمز مُستَقِلّ **لا مُشتَقّ ولا مُعاد
        // استِعمالُه**، وذلك قَرار لَه سَبَب واحِد قاطِع: النُجوم
        // لَيسَت تَحذيراً. لَو رُبِطَت بِـcolor.warning لَصارَ أَوَّلُ
        // مُستَأجِر يُلَوِّن تَحذيرَه أَحمَرَ **يُلَوِّن تَقييماتِه
        // حَمراء** — أَي أَنّ إعداداً في نِطاق وظيفةٍ يُفسِد نِطاق
        // وظيفَةٍ أُخرى بِلا رابِط بَينَهُما. وبِـcolor.secondary
        // نَفسُ العَطَب مِن الجِهَة الأُخرى: الثانَويّ لَون إجراء
        // ومُشتَقّاتُه (‏--ac-secondary-hover) لِلتَفاعُل، والنَجمَة
        // لا تُنقَر.
        //
        // ‏**وهو تَعبِئَة أَيقونَة لا لَون نَصّ** — مَقيس لا مَظنون:
        // مَواضِعُه الثَلاثَة كُلُّها تُلَوِّن <AcIcon> وَحدَها
        // (‏svg بِـfill/stroke = currentColor)، والنَصّ المُجاوِر
        // يَضبِط لَونَه بِنَفسِه (‏--ac-text-muted). ولِذلك **لا يَدخُل
        // ThemeContrastRule.Pairs**: قاعِدَة 1.4.3 لِلنَصّ، وإدراجُه
        // كانَ سَيَرُدّ الثيم الافتِراضيّ نَفسَه (‏#f59e0b على أَبيَض
        // = 2.148 دونَ 4.5) فَيُفشِل الإقلاع بِخَرقٍ خَياليّ.
        new("color.rating",         "--wsl-color-rating",         ThemeTokenKind.Color),
