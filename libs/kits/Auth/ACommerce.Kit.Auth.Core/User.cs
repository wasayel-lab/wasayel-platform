...
public sealed class User
{
    ...
    /// <summary>
    /// <para>مَتى حُذِفَ هذا الحِسابُ مِن داخِلِ التَطبيق.
    /// <c>null</c> = حِسابٌ قائِم.</para>
    ///
    /// <para><b>ولِماذا عَلامَةٌ لا مَحوٌ لِلوَثيقَة</b>: الصَفَقاتُ
    /// والفَواتيرُ تُشيرُ إلى هذا المُعَرِّف، ومَحوُ الوَثيقَةِ
    /// يَترُكُ سِجِلّاً مالِيّاً بِطَرَفٍ مَفقود. فَـ<c>AccountDeletion.Erase</c>
    /// يُزيلُ كُلَّ ما يَدُلُّ عَلى الشَخصِ ويَرفَعُ هذِه العَلامَة،
    /// ويَبقى الصَفُّ بِلا اسمٍ ولا وَسيلَةِ اتِّصال. والمُبَرِّرُ
    /// كامِلاً في <c>AccountDeletion</c>.</para>
    /// </summary>
