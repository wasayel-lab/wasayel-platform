...
public sealed class TenantResolverMiddleware
{
    ...
    /// <b>يُرسِلُه العَميل</b>، والمَنَصَّةُ تُشَغِّلُ
    /// <c>ForwardedHeaders.XForwardedHost</c> بِلا وُكَلاءَ
    /// مَوثوقين — فَلَولا اشتِراطُ اللاحِقَةِ لَصارَ رَأسُ
    /// <c>Host</c> باباً يَختارُ بِه أَيُّ أَحَدٍ سِياقَ أَيِّ
    /// مُستَأجِر. والاشتِراطُ يَقَعُ على <b>«‏نُقطَة + النِطاق‏»</b>
