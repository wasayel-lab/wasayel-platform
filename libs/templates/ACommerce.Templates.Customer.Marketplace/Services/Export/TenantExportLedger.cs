...
public static class TenantExportLedger
{
    public static IReadOnlyList<ExportedType> All { get; } = new ExportedType[]
    {
        ...
        new(typeof(Metering.ModelCallRecord), "-", ExportDisposition.ExcludeInternal,
            "سَطرُ قياسِ نِداءِ نَموذَجِ لُغَة — توكناتٌ وكِلفَةٌ على " +
            "**مِفتاحِ المالِكِ وفاتورَتِه هُوَ**، لا على حِسابِ " +
            "المُستَأجِر. وهي مَقاييسُ تَشغيلِنا الداخِليّ (مُزَوِّدٌ " +
            "ونَموذَجٌ وكِلفَة) لا بَياناتُ مَتجَر. **ولا مُحتَوى " +
            "فيها أَصلاً**: لا نَصَّ طَلَبٍ ولا نَصَّ رَدٍّ — فَما " +
            "مِن شَيءٍ يَخُصُّ العَميلَ يُحجَبُ عَنه بِهذا الاستِثناء."),
