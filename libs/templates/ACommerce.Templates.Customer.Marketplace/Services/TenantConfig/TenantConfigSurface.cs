...
public static class TenantConfigSurface
{
    ...
    /// إلى الافتِراضيّ.
    ///
    /// <para><b>‏2026-08-30 — والمُبَرِّرُ الأَوَّلُ سَقَطَ ولَم يَسقُط
    /// العَقد.</b> كانَ مَكتوباً هُنا: «صَفحَةُ الاستوديو لا تُدير
    /// القَناة، فَلا يَجوز أَن يَمحُوَها حِفظُ الاسم». وصَفحَةُ
    /// الاستوديو <b>صارَت تُديرُها</b> — لِأَنّ عَدَمَ إدارَتِها كانَ هُوَ
    /// العَطَب: مَتجَرٌ يَبنيه عَميلٌ بِنَفسِه كانَ يُولَدُ بِقَناةٍ
    /// ثابِتَةٍ قَد لا تَكونُ مُسَجَّلَةً في النُسخَة، ولا يَملِكُ
    /// صاحِبُه تَبديلَها. <b>والعَقدُ يَبقى كَما هُوَ</b> لِأَنَّ سَبَبَه
    /// أَوسَعُ مِن تِلكَ الصَفحَة: أَيُّ سَطحٍ لا يُرسِل الحَقلَ (نُقطَةُ
    /// JSON، تَطبيقٌ أَصيل، نَموذَجٌ جُزئيّ) يَجِبُ ألّا يَمحُوَ قَناةَ
    /// مُستَأجِرٍ على نَفاذ بِحِفظِ اسمِه.</para></summary>
