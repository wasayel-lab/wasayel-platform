...
public class EndpointBodyBleedTests
{
    ...
    {
        new("libs/templates/ACommerce.Templates.Customer.Marketplace/MarketplaceTemplateExtensions.cs", 2385),
    };
    ...
    /// هُنا ‏17 و‏15.</para></summary>
    private const int PinnedTotal = 2385;
    ...
    /// بِدونِها.</para></summary>
    private const int PinnedEndpointCount = 105;
