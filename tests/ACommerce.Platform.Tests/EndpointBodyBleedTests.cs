...
public class EndpointBodyBleedTests
{
    ...
    {
        new("libs/templates/ACommerce.Templates.Customer.Marketplace/MarketplaceTemplateExtensions.cs", 2314),
    };
    ...
    /// والجَديدَتانِ ‏16 لِكُلٍّ.</para></summary>
    private const int PinnedTotal = 2314;
    ...
    /// لِسَبَبَينِ مُختَلِفَين، ولِذلك هُما رَقَمان.</para></summary>
    private const int PinnedEndpointCount = 101;
