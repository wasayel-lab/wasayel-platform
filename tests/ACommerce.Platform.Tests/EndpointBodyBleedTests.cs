...
public class EndpointBodyBleedTests
{
    ...
    private static readonly Ceiling[] PinnedCeilings =
    {
        ...
        new("libs/templates/ACommerce.Templates.Customer.Marketplace/MarketplaceTemplateExtensions.cs", 2434),
    ...
    /// تُعلَن.</para>
    /// </summary>
    private const int PinnedTotal = 2474;
    ...
    private const int PinnedEndpointCount = 111;
