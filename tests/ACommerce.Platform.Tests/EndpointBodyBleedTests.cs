...
public class EndpointBodyBleedTests
{
    ...
    {
        new("libs/templates/ACommerce.Templates.Customer.Marketplace/MarketplaceTemplateExtensions.cs", 2343),
    };
    ...
    /// ← <b>2343</b> يَوم ‏2026-08-16 (‏المَوجَة ٧). ‏<b>29 سَطراً</b> في
    /// نُقطَتَي إشعارِ القِراءَة —
    ...
    /// صَفحَة.</para></summary>
    private const int PinnedTotal = 2343;
    ...
    ///
    /// <para>‏101 ← <b>103</b> في المَوجَة ٧ — نُقطَتا إشعارِ القِراءَة.
    /// وهي حالَةٌ ثالِثَة لِارتِفاعِ هذا العَدَد: لا فَجوَةُ مُنتَجٍ
    /// تُسَدّ ولا مَنطِقٌ يُكتَب، بَل <b>كِتابَةٌ تُنقَل مِن طَلَبِ
    /// عَرضٍ إلى أَمرٍ صَريح</b>. فَكُلُّ نُقطَةٍ جَديدَةٍ هُنا ثَمَنُ
    /// إدخالَةٍ تَخرُج مِن سِجِلّ الطَبَقَة الثامِنَة.</para></summary>
    private const int PinnedEndpointCount = 103;
