...
public class AdminStudioPairCharacterizationTests
{
    ...
    private static readonly Pair[] Pinned =
    {
        new("branding", PairState.Unified,
            ...
            "حِفظُ الاسمِ مِن أَيّ سَطحٍ لا يُرسِل الحَقل (نُقطَةُ JSON، تَطبيقٌ أَصيل، نَموذَجٌ " +
            "جُزئيّ) قَناةَ مُستَأجِرٍ على نَفاذ. ورُموزُ الخَطَأ غَلَبَت فيها صيغَةُ /admin " +
            "لِأَنَّها تَقول العِلَّة (name_required) لا الحَقل (name). " +
            "‏[‏2026-08-30] وكانَ هُنا «وصَفحَةُ الاستوديو لا تُدير القَناة أَصلاً» — صارَت " +
            "تُديرُها، ولِذلك حُذِفَت الجُملَة: **عَدَمُ إدارَتِها كانَ هُوَ العَطَب**، فَمَتجَرٌ " +
            "يَبنيه عَميلٌ بِنَفسِه كانَ يُولَدُ على قَناةٍ ثابِتَةٍ قَد لا تَكون مُسَجَّلَةً في " +
            "النُسخَة ولا يَملِك صاحِبُه تَبديلَها. والعَقدُ لَم يَتَغَيَّر — الحُجَّةُ وَحدَها هي " +
            "الَّتي كانَت أَضيَقَ مِن سَبَبِها. راجِع TenantAuthChannelDoor."),
