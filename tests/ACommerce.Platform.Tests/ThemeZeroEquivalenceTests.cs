...
public class ThemeZeroEquivalenceTests
{
        ...
        DeliberateDivergences =
    {
        ("--ac-text-soft", "#a1a1aa", "#6d6d76",
         ...
         "والثالِثَة (‏2026-08-22): الخافِتُ والمَكتومُ قيمَةٌ واحِدَةٌ " +
         "مُثَبَّتَةٌ بِـTheDefaultThemeHasTwoTextLayersNotThree، فَتَحَرَّكا " +
         "مَعاً إلى ‏#6d6d76 — والسَبَبُ كُلُّه في سَطر المَكتوم أَدناه."),

        ("--ac-text-muted", "#71717a", "#6d6d76",
         ...
         "**والمَرحَلَة الثالِثَة (‏2026-08-22)**: أَمسَكَت الطَبَقَةُ " +
         "السادِسَةُ حَيّاً على /admin/tenants/new زَوجاً لَم يَبلُغهُ أَيُّ " +
         "حِسابٍ ساكِن — ‏#6f6f78 على ‏rgb(237,241,252) نِسبَتُه 4.404. " +
         "والخَلفِيَّةُ لَيسَت رَمزاً بَل " +
         "color-mix(in srgb, var(--ac-primary) 8%, transparent) في " +
         "site.css:151 (‏.acm-radio-card:has(input:checked)) مُرَكَّبَةً " +
         "فَوقَ الأَبيَض. خُطوَةٌ واحِدَة (‏#6e6e77) تَقصُر عِندَ 4.469، " +
         "وخُطوَتان (‏#6d6d76) تَبلُغ 4.535 — وتَرفَع الباقيَ مَعَها: " +
         "‏4.661 على bgAlt و4.908 على bg و5.123 على surface."),
    };
