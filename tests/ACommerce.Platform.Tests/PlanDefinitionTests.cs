...
public class PlanDefinitionTests
{
    ...
    // ─── شَرط الاستِخراج: أَربَعَة مُستَهلِكين ────────────────────────

    /// <summary>
    /// <para><b>القاعِدَة ١ مَفروضَةً لا مَوصوفَة</b>: القالِب المُشتَرَك
    /// لَه <b>أَربَعَة</b> مُستَهلِكين في وَقت التَشغيل — الأَدوار
    /// والمَظهَر والباقات <b>ورَبطُ المُزَوِّدين</b>. كانَ اثنَين قَبل
    /// مَوجَةِ الباقات، والاستِخراج حينَها كانَ سَيَكون تَجريداً يَسبِق
    /// مُستَهلِكَه — أَي العَطَب الَّذي عالَجَتهُ تِلكَ المَوجَة.</para>
    ///
    /// <para><b>والرابِعُ يُقاس ولا يُدَّعى</b> (‏2026-08-30، ‏ADR-012):
    /// رَبطُ المُزَوِّدِ لَم يَبنِ أُنبوباً خامِساً — وَرِثَ الكاشَ
    /// بِمِفتاحِ السلاج والقِراءَةَ بِجَلسَةِ المُستَأجِرِ والسُقوطَ
    /// الآمِنَ والإبطالَ مِن هذا القالِبِ بِعَينِه (القاعِدَة ٨).</para>
    ///
    /// <para><b>ونُقصانُهُم يُحَمِّر</b>: لَو حُذِفَ مُستَهلِك صارَ
    /// القالِبُ تَجريداً لِثَلاثَة — وذلك قَرار يَستَحِقّ نَظَرَ إنسان،
    /// لا تَعديلاً يَمُرّ.</para>
    /// </summary>
    [Fact]
    public void The_shared_template_has_exactly_four_runtime_consumers()
    {
        ...
        Assert.Equal(
            new[] { "TenantPlanService", "TenantProviderService",
                    "TenantRoleService", "TenantThemeService" },
            consumers);
    }
