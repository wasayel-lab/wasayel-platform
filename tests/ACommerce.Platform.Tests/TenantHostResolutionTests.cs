...
/// أَيُّ أَحَدٍ سِياقَ أَيِّ مُستَأجِر. فَالشَرطُ هُنا لَيسَ
/// تَجميلاً؛ هُوَ القُفل.
/// و<see cref="A_host_outside_the_base_domain_resolves_no_tenant"/>
/// هُوَ البُرهان.</para>
///
/// <para><b>وتَصحيحٌ لِما كانَ مَكتوباً هُنا</b>: قيلَ إنَّ
/// المَنَصَّةَ تُشَغِّلُ <c>ForwardedHeaders.XForwardedHost</c> بِلا
/// وُكَلاءَ مَوثوقين. كانَ صَحيحاً حَتّى ‏2026-08-30، ثُمَّ سُدَّ
/// (‏<c>ForwardedHostSpoofTests</c> وADR-023): الرَأسُ لا يُقرَأُ بِلا
/// قائِمَةٍ مُهَيَّأَة. <b>والقُفلُ هُنا يَبقى لِأَنَّ سَبَبَه
/// يَبقى</b> — رَأسُ <c>Host</c> نَفسُه يَكتُبُه العَميلُ حينَ لا
/// وَسيطَ بَينَه وبَينَ الخادِم.</para>
/// </summary>
