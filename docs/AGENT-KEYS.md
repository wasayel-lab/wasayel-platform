...
|---|---|---|
| **‏401** | **مُصادَقَة، لا حِصَّة.** المِفتاحُ غائِبٌ أَو مُبطَلٌ أَو **مُرسَلٌ إلى خادِمٍ لا يَعرِفُه** | اقرَأ سَطرَ `[agent]`: أَيُطابِقُ العُنوانُ مُصدِرَ المِفتاح؟ غالِبُ الحالاتِ `BaseUrl` غائِب |
