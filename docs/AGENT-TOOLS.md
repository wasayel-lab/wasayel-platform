...
> **⛔ مُتَقاعِد — لا يُنفَّذ (‏2026-08-31).** أُغلِقَ **GitHub Models**
> نِهائِيّاً في **2026-07-30**: العنوان أدناه يردّ **410 Gone** بِلا رمز
> وبِرمزٍ مزيّف سواء (قيسَ اليوم)، والعنوان الأقدم
> `models.inference.ai.azure.com` لا يُحلّ في DNS
> ([الإعلان](https://github.blog/changelog/2026-07-30-github-models-is-now-retired/)).
> **ويبقى المثال هنا لأنّ ما يوضّحه ما زال صحيحاً**: شكل التهيئة الثنائية،
> واقتسام الخلفية عند تطابق المفتاح والعنوان، وسقوط `Agents:*` إلى `Agent:*`.
> **بدائل عاملة وتشخيص 401/404/429 في [`AGENT-KEYS.md`](AGENT-KEYS.md).**
> وحدّ «شكل المسار لم يُتحقّق حيّاً» أدناه **لن يُتحقَّق أبداً على هذا
> المزوّد** — وقد تحقّق فعلياً على Groq وCerebras وOpenRouter.
